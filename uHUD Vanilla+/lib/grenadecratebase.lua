function GrenadeCrateBase:_create_workspace()
	...
	self._ws_t = self._ws:panel():text({
		name 		= "amount",
		text 		= tostring( self._grenade_amount or 0 ),
		y 			= 0,
...
function GrenadeCrateBase:_destroy_workspace()
...
function GrenadeCrateBase:_attach()
...
Hooks:PostHook( GrenadeCrateBase , "_set_visual_stage" , "uHUDPostGrenadeCrateBaseSetVisualStage" , function( self )
...
Hooks:PreHook( GrenadeCrateBase , "update" , "uHUDPreGrenadeCrateBaseUpdate" , function( self , unit , t , dt )
	...
	self._ws_t:set_text( tostring( self._grenade_amount or 0 ) )

end )

Hooks:PostHook( GrenadeCrateBase , "destroy" , "uHUDPostGrenadeCrateBaseDestroy" , function( self )
